                                            ...
                                            Padding(
                                              ...
                                              child: ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(8.0),
                                                child: Image.asset(
                                                  'assets/images/d9e5h01-3d9a5714-9324-4da0-90c2-36de038005fb.png',
                                                  width: 25.0,
                                                  height: 25.0,
                                                  fit: BoxFit.cover,
                                                ),
                                    ...
                                    onPressed: () async {
                                      setState(() {
                                        FFAppState().currentLevel =
                                            FFAppState().currentLevel + 1;
                                      });
                                      setState(() {
                                        FFAppState().updateLevelsListAtIndex(
                                          FFAppState().currentLevel,
                                          (e) => e
                                            ..isLevelLocked = false
                                            ..completionPerc = random_data
